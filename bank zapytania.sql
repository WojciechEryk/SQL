...
#SELECT CONCAT_WS(' ', imie, nazwisko) AS "Imie Nazwisko", (Select CONCAT_WS(' ', imie, nazwisko)FROM bank_v2.pracownicy where id_pracownika = 150) as "przelozony" FROM bank_v2.pracownicy where id_przelozonego = 150;
